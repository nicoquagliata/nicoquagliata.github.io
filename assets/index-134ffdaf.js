...
}`;class HomePanorama{constructor(e,t,n,i){this.experience=new WebExperience,this.scene=this.experience.scene,this.time=this.experience.time,this.geometry=new SphereGeometry(100,60,40),this.geometry.scale(-1,1,1),this.geometry.doubleSided=!0,this.texture=e,this.maskBottle=t,this.noise=n,this.bMask=i,this.texture.colorSpace=SRGBColorSpace;const r={u_time:{value:0},u_map:{value:this.texture},u_maskBottle:{value:this.maskBottle},u_bMask:{value:this.bMask},u_noise:{value:this.noise},u_mix:{value:1},u_opacity:{value:0},u_transition:{value:0},u_scale:{value:.1},u_scale_loop:{value:1}};this.shaderMaterial=new ShaderMaterial({vertexShader:vertex_default,fragmentShader:fragment_default,uniforms:r,side:FrontSide,transparent:!0,depthTest:!0,depthWrite:!1});let a=`
			varying vec2 vUv;

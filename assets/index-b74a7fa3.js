...
`)+`
`+m,f=["precision mediump sampler2DArray;","#define varying in",t.glslVersion===GLSL3?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===GLSL3?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+f);const v=x+m+a,S=x+f+o,M=WebGLShader(i,i.VERTEX_SHADER,v),A=WebGLShader(i,i.FRAGMENT_SHADER,S);i.attachShader(_,M),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(V){if(s.debug.checkShaderErrors){const W=i.getProgramInfoLog(_).trim(),j=i.getShaderInfoLog(M).trim(),D=i.getShaderInfoLog(A).trim();let O=!0,$=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(O=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,M,A);else{const G=getShaderErrors(i,M,"vertex"),Z=getShaderErrors(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`

Program Info Log: `+W+`
`+G+`
`+Z)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(j===""||D==="")&&($=!1);$&&(V.diagnostics={runnable:O,programLog:W,vertexShader:{log:j,prefix:m},fragmentShader:{log:D,prefix:f}})}i.deleteShader(M),i.deleteShader(A),P=new WebGLUniforms(i,_),y=fetchAttributeLocations(i,_)}let P;this.getUniforms=function(){return P===void 0&&E(this),P};let y;this.getAttributes=function(){return y===void 0&&E(this),y};let w=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=i.getProgramParameter(_,COMPLETION_STATUS_KHR)),w},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=programIdCount++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=M,this.fragmentShader=A,this}let _id$1=0;class WebGLShaderCache{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new WebGLShaderStage(e),t.set(e,n)),n}}class WebGLShaderStage{constructor(e){this.id=_id$1++,this.code=e,this.usedTimes=0}}function WebGLPrograms(s,e,t,n,i,r,a){const o=new Layers,l=new WebGLShaderCache,c=[],h=i.isWebGL2,u=i.logarithmicDepthBuffer,d=i.vertexTextures;let p=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(y){return y===0?"uv":`uv${y}`}function m(y,w,V,W,j){const D=W.fog,O=j.geometry,$=y.isMeshStandardMaterial?W.environment:null,G=(y.isMeshStandardMaterial?t:e).get(y.envMap||$),Z=G&&G.mapping===CubeUVReflectionMapping?G.image.height:null,K=g[y.type];y.precision!==null&&(p=i.getMaxPrecision(y.precision),p!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",p,"instead."));const q=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,I=q!==void 0?q.length:0;let k=0;O.morphAttributes.position!==void 0&&(k=1),O.morphAttributes.normal!==void 0&&(k=2),O.morphAttributes.color!==void 0&&(k=3);let oe,ae,le,Se;if(K){const We=ShaderLib[K];oe=We.vertexShader,ae=We.fragmentShader}else oe=y.vertexShader,ae=y.fragmentShader,l.update(y),le=l.getVertexShaderID(y),Se=l.getFragmentShaderID(y);const Ie=s.getRenderTarget(),Me=j.isInstancedMesh===!0,Ae=!!y.map,ke=!!y.matcap,Le=!!G,U=!!y.aoMap,qe=!!y.lightMap,ge=!!y.bumpMap,Te=!!y.normalMap,Ee=!!y.displacementMap,Ve=!!y.emissiveMap,Re=!!y.metalnessMap,we=!!y.roughnessMap,Fe=y.anisotropy>0,He=y.clearcoat>0,Xe=y.iridescence>0,C=y.sheen>0,T=y.transmission>0,F=Fe&&!!y.anisotropyMap,ee=He&&!!y.clearcoatMap,J=He&&!!y.clearcoatNormalMap,te=He&&!!y.clearcoatRoughnessMap,fe=Xe&&!!y.iridescenceMap,re=Xe&&!!y.iridescenceThicknessMap,ce=C&&!!y.sheenColorMap,R=C&&!!y.sheenRoughnessMap,ie=!!y.specularMap,Y=!!y.specularColorMap,xe=!!y.specularIntensityMap,pe=T&&!!y.transmissionMap,ve=T&&!!y.thicknessMap,de=!!y.gradientMap,ue=!!y.alphaMap,Ne=y.alphaTest>0,L=!!y.alphaHash,se=!!y.extensions,Q=!!O.attributes.uv1,X=!!O.attributes.uv2,ne=!!O.attributes.uv3;let _e=NoToneMapping;return y.toneMapped&&(Ie===null||Ie.isXRRenderTarget===!0)&&(_e=s.toneMapping),{isWebGL2:h,shaderID:K,shaderType:y.type,shaderName:y.name,vertexShader:oe,fragmentShader:ae,defines:y.defines,customVertexShaderID:le,customFragmentShaderID:Se,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:p,instancing:Me,instancingColor:Me&&j.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:Ie===null?s.outputColorSpace:Ie.isXRRenderTarget===!0?Ie.texture.colorSpace:LinearSRGBColorSpace,map:Ae,matcap:ke,envMap:Le,envMapMode:Le&&G.mapping,envMapCubeUVHeight:Z,aoMap:U,lightMap:qe,bumpMap:ge,normalMap:Te,displacementMap:d&&Ee,emissiveMap:Ve,normalMapObjectSpace:Te&&y.normalMapType===ObjectSpaceNormalMap,normalMapTangentSpace:Te&&y.normalMapType===TangentSpaceNormalMap,metalnessMap:Re,roughnessMap:we,anisotropy:Fe,anisotropyMap:F,clearcoat:He,clearcoatMap:ee,clearcoatNormalMap:J,clearcoatRoughnessMap:te,iridescence:Xe,iridescenceMap:fe,iridescenceThicknessMap:re,sheen:C,sheenColorMap:ce,sheenRoughnessMap:R,specularMap:ie,specularColorMap:Y,specularIntensityMap:xe,transmission:T,transmissionMap:pe,thicknessMap:ve,gradientMap:de,opaque:y.transparent===!1&&y.blending===NormalBlending,alphaMap:ue,alphaTest:Ne,alphaHash:L,combine:y.combine,mapUv:Ae&&_(y.map.channel),aoMapUv:U&&_(y.aoMap.channel),lightMapUv:qe&&_(y.lightMap.channel),bumpMapUv:ge&&_(y.bumpMap.channel),normalMapUv:Te&&_(y.normalMap.channel),displacementMapUv:Ee&&_(y.displacementMap.channel),emissiveMapUv:Ve&&_(y.emissiveMap.channel),metalnessMapUv:Re&&_(y.metalnessMap.channel),roughnessMapUv:we&&_(y.roughnessMap.channel),anisotropyMapUv:F&&_(y.anisotropyMap.channel),clearcoatMapUv:ee&&_(y.clearcoatMap.channel),clearcoatNormalMapUv:J&&_(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:te&&_(y.clearcoatRoughnessMap.channel),iridescenceMapUv:fe&&_(y.iridescenceMap.channel),iridescenceThicknessMapUv:re&&_(y.iridescenceThicknessMap.channel),sheenColorMapUv:ce&&_(y.sheenColorMap.channel),sheenRoughnessMapUv:R&&_(y.sheenRoughnessMap.channel),specularMapUv:ie&&_(y.specularMap.channel),specularColorMapUv:Y&&_(y.specularColorMap.channel),specularIntensityMapUv:xe&&_(y.specularIntensityMap.channel),transmissionMapUv:pe&&_(y.transmissionMap.channel),thicknessMapUv:ve&&_(y.thicknessMap.channel),alphaMapUv:ue&&_(y.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(Te||Fe),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,vertexUv1s:Q,vertexUv2s:X,vertexUv3s:ne,pointsUvs:j.isPoints===!0&&!!O.attributes.uv&&(Ae||ue),fog:!!D,useFog:y.fog===!0,fogExp2:D&&D.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:u,skinning:j.isSkinnedMesh===!0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:I,morphTextureStride:k,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:y.dithering,shadowMapEnabled:s.shadowMap.enabled&&V.length>0,shadowMapType:s.shadowMap.type,toneMapping:_e,useLegacyLights:s._useLegacyLights,decodeVideoTexture:Ae&&y.map.isVideoTexture===!0&&ColorManagement.getTransfer(y.map.colorSpace)===SRGBTransfer,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===DoubleSide,flipSided:y.side===BackSide,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionDerivatives:se&&y.extensions.derivatives===!0,extensionFragDepth:se&&y.extensions.fragDepth===!0,extensionDrawBuffers:se&&y.extensions.drawBuffers===!0,extensionShaderTextureLOD:se&&y.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:h||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:h||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:h||n.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()}}function f(y){const w=[];if(y.shaderID?w.push(y.shaderID):(w.push(y.customVertexShaderID),w.push(y.customFragmentShaderID)),y.defines!==void 0)for(const V in y.defines)w.push(V),w.push(y.defines[V]);return y.isRawShaderMaterial===!1&&(x(w,y),v(w,y),w.push(s.outputColorSpace)),w.push(y.customProgramCacheKey),w.join()}function x(y,w){y.push(w.precision),y.push(w.outputColorSpace),y.push(w.envMapMode),y.push(w.envMapCubeUVHeight),y.push(w.mapUv),y.push(w.alphaMapUv),y.push(w.lightMapUv),y.push(w.aoMapUv),y.push(w.bumpMapUv),y.push(w.normalMapUv),y.push(w.displacementMapUv),y.push(w.emissiveMapUv),y.push(w.metalnessMapUv),y.push(w.roughnessMapUv),y.push(w.anisotropyMapUv),y.push(w.clearcoatMapUv),y.push(w.clearcoatNormalMapUv),y.push(w.clearcoatRoughnessMapUv),y.push(w.iridescenceMapUv),y.push(w.iridescenceThicknessMapUv),y.push(w.sheenColorMapUv),y.push(w.sheenRoughnessMapUv),y.push(w.specularMapUv),y.push(w.specularColorMapUv),y.push(w.specularIntensityMapUv),y.push(w.transmissionMapUv),y.push(w.thicknessMapUv),y.push(w.combine),y.push(w.fogExp2),y.push(w.sizeAttenuation),y.push(w.morphTargetsCount),y.push(w.morphAttributeCount),y.push(w.numDirLights),y.push(w.numPointLights),y.push(w.numSpotLights),y.push(w.numSpotLightMaps),y.push(w.numHemiLights),y.push(w.numRectAreaLights),y.push(w.numDirLightShadows),y.push(w.numPointLightShadows),y.push(w.numSpotLightShadows),y.push(w.numSpotLightShadowsWithMaps),y.push(w.numLightProbes),y.push(w.shadowMapType),y.push(w.toneMapping),y.push(w.numClippingPlanes),y.push(w.numClipIntersection),y.push(w.depthPacking)}function v(y,w){o.disableAll(),w.isWebGL2&&o.enable(0),w.supportsVertexTextures&&o.enable(1),w.instancing&&o.enable(2),w.instancingColor&&o.enable(3),w.matcap&&o.enable(4),w.envMap&&o.enable(5),w.normalMapObjectSpace&&o.enable(6),w.normalMapTangentSpace&&o.enable(7),w.clearcoat&&o.enable(8),w.iridescence&&o.enable(9),w.alphaTest&&o.enable(10),w.vertexColors&&o.enable(11),w.vertexAlphas&&o.enable(12),w.vertexUv1s&&o.enable(13),w.vertexUv2s&&o.enable(14),w.vertexUv3s&&o.enable(15),w.vertexTangents&&o.enable(16),w.anisotropy&&o.enable(17),w.alphaHash&&o.enable(18),y.push(o.mask),o.disableAll(),w.fog&&o.enable(0),w.useFog&&o.enable(1),w.flatShading&&o.enable(2),w.logarithmicDepthBuffer&&o.enable(3),w.skinning&&o.enable(4),w.morphTargets&&o.enable(5),w.morphNormals&&o.enable(6),w.morphColors&&o.enable(7),w.premultipliedAlpha&&o.enable(8),w.shadowMapEnabled&&o.enable(9),w.useLegacyLights&&o.enable(10),w.doubleSided&&o.enable(11),w.flipSided&&o.enable(12),w.useDepthPacking&&o.enable(13),w.dithering&&o.enable(14),w.transmission&&o.enable(15),w.sheen&&o.enable(16),w.opaque&&o.enable(17),w.pointsUvs&&o.enable(18),w.decodeVideoTexture&&o.enable(19),y.push(o.mask)}function S(y){const w=g[y.type];let V;if(w){const W=ShaderLib[w];V=UniformsUtils.clone(W.uniforms)}else V=y.uniforms;return V}function M(y,w){let V;for(let W=0,j=c.length;W<j;W++){const D=c[W];if(D.cacheKey===w){V=D,++V.usedTimes;break}}return V===void 0&&(V=new WebGLProgram(s,w,y,r),c.push(V)),V}function A(y){if(--y.usedTimes===0){const w=c.indexOf(y);c[w]=c[c.length-1],c.pop(),y.destroy()}}function E(y){l.remove(y)}function P(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:S,acquireProgram:M,releaseProgram:A,releaseShaderCache:E,programs:c,dispose:P}}function WebGLProperties(){let s=new WeakMap;function e(r){let a=s.get(r);return a===void 0&&(a={},s.set(r,a)),a}function t(r){s.delete(r)}function n(r,a,o){s.get(r)[a]=o}function i(){s=new WeakMap}return{get:e,remove:t,update:n,dispose:i}}function painterSortStable(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function reversePainterSortStable(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function WebGLRenderList(){const s=[];let e=0;const t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function a(u,d,p,g,_,m){let f=s[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},s[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=_,f.group=m),e++,f}function o(u,d,p,g,_,m){const f=a(u,d,p,g,_,m);p.transmission>0?n.push(f):p.transparent===!0?i.push(f):t.push(f)}function l(u,d,p,g,_,m){const f=a(u,d,p,g,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?i.unshift(f):t.unshift(f)}function c(u,d){t.length>1&&t.sort(u||painterSortStable),n.length>1&&n.sort(d||reversePainterSortStable),i.length>1&&i.sort(d||reversePainterSortStable)}function h(){for(let u=e,d=s.length;u<d;u++){const p=s[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:o,unshift:l,finish:h,sort:c}}function WebGLRenderLists(){let s=new WeakMap;function e(n,i){const r=s.get(n);let a;return r===void 0?(a=new WebGLRenderList,s.set(n,[a])):i>=r.length?(a=new WebGLRenderList,r.push(a)):a=r[i],a}function t(){s=new WeakMap}return{get:e,dispose:t}}function UniformsCache(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new Vector3,color:new Color};break;case"SpotLight":t={position:new Vector3,direction:new Vector3,color:new Color,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new Vector3,color:new Color,distance:0,decay:0};break;case"HemisphereLight":t={direction:new Vector3,skyColor:new Color,groundColor:new Color};break;case"RectAreaLight":t={color:new Color,position:new Vector3,halfWidth:new Vector3,halfHeight:new Vector3};break}return s[e.id]=t,t}}}function ShadowUniformsCache(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vector2};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vector2};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vector2,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let nextVersion=0;function shadowCastingAndTexturingLightsFirst(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function WebGLLights(s,e){const t=new UniformsCache,n=ShadowUniformsCache(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let h=0;h<9;h++)i.probe.push(new Vector3);const r=new Vector3,a=new Matrix4,o=new Matrix4;function l(h,u){let d=0,p=0,g=0;for(let W=0;W<9;W++)i.probe[W].set(0,0,0);let _=0,m=0,f=0,x=0,v=0,S=0,M=0,A=0,E=0,P=0,y=0;h.sort(shadowCastingAndTexturingLightsFirst);const w=u===!0?Math.PI:1;for(let W=0,j=h.length;W<j;W++){const D=h[W],O=D.color,$=D.intensity,G=D.distance,Z=D.shadow&&D.shadow.map?D.shadow.map.texture:null;if(D.isAmbientLight)d+=O.r*$*w,p+=O.g*$*w,g+=O.b*$*w;else if(D.isLightProbe){for(let K=0;K<9;K++)i.probe[K].addScaledVector(D.sh.coefficients[K],$);y++}else if(D.isDirectionalLight){const K=t.get(D);if(K.color.copy(D.color).multiplyScalar(D.intensity*w),D.castShadow){const q=D.shadow,I=n.get(D);I.shadowBias=q.bias,I.shadowNormalBias=q.normalBias,I.shadowRadius=q.radius,I.shadowMapSize=q.mapSize,i.directionalShadow[_]=I,i.directionalShadowMap[_]=Z,i.directionalShadowMatrix[_]=D.shadow.matrix,S++}i.directional[_]=K,_++}else if(D.isSpotLight){const K=t.get(D);K.position.setFromMatrixPosition(D.matrixWorld),K.color.copy(O).multiplyScalar($*w),K.distance=G,K.coneCos=Math.cos(D.angle),K.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),K.decay=D.decay,i.spot[f]=K;const q=D.shadow;if(D.map&&(i.spotLightMap[E]=D.map,E++,q.updateMatrices(D),D.castShadow&&P++),i.spotLightMatrix[f]=q.matrix,D.castShadow){const I=n.get(D);I.shadowBias=q.bias,I.shadowNormalBias=q.normalBias,I.shadowRadius=q.radius,I.shadowMapSize=q.mapSize,i.spotShadow[f]=I,i.spotShadowMap[f]=Z,A++}f++}else if(D.isRectAreaLight){const K=t.get(D);K.color.copy(O).multiplyScalar($),K.halfWidth.set(D.width*.5,0,0),K.halfHeight.set(0,D.height*.5,0),i.rectArea[x]=K,x++}else if(D.isPointLight){const K=t.get(D);if(K.color.copy(D.color).multiplyScalar(D.intensity*w),K.distance=D.distance,K.decay=D.decay,D.castShadow){const q=D.shadow,I=n.get(D);I.shadowBias=q.bias,I.shadowNormalBias=q.normalBias,I.shadowRadius=q.radius,I.shadowMapSize=q.mapSize,I.shadowCameraNear=q.camera.near,I.shadowCameraFar=q.camera.far,i.pointShadow[m]=I,i.pointShadowMap[m]=Z,i.pointShadowMatrix[m]=D.shadow.matrix,M++}i.point[m]=K,m++}else if(D.isHemisphereLight){const K=t.get(D);K.skyColor.copy(D.color).multiplyScalar($*w),K.groundColor.copy(D.groundColor).multiplyScalar($*w),i.hemi[v]=K,v++}}x>0&&(e.isWebGL2||s.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=UniformsLib.LTC_FLOAT_1,i.rectAreaLTC2=UniformsLib.LTC_FLOAT_2):s.has("OES_texture_half_float_linear")===!0?(i.rectAreaLTC1=UniformsLib.LTC_HALF_1,i.rectAreaLTC2=UniformsLib.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),i.ambient[0]=d,i.ambient[1]=p,i.ambient[2]=g;const V=i.hash;(V.directionalLength!==_||V.pointLength!==m||V.spotLength!==f||V.rectAreaLength!==x||V.hemiLength!==v||V.numDirectionalShadows!==S||V.numPointShadows!==M||V.numSpotShadows!==A||V.numSpotMaps!==E||V.numLightProbes!==y)&&(i.directional.length=_,i.spot.length=f,i.rectArea.length=x,i.point.length=m,i.hemi.length=v,i.directionalShadow.length=S,i.directionalShadowMap.length=S,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=A,i.spotShadowMap.length=A,i.directionalShadowMatrix.length=S,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=A+E-P,i.spotLightMap.length=E,i.numSpotLightShadowsWithMaps=P,i.numLightProbes=y,V.directionalLength=_,V.pointLength=m,V.spotLength=f,V.rectAreaLength=x,V.hemiLength=v,V.numDirectionalShadows=S,V.numPointShadows=M,V.numSpotShadows=A,V.numSpotMaps=E,V.numLightProbes=y,i.version=nextVersion++)}function c(h,u){let d=0,p=0,g=0,_=0,m=0;const f=u.matrixWorldInverse;for(let x=0,v=h.length;x<v;x++){const S=h[x];if(S.isDirectionalLight){const M=i.directional[d];M.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(f),d++}else if(S.isSpotLight){const M=i.spot[g];M.position.setFromMatrixPosition(S.matrixWorld),M.position.applyMatrix4(f),M.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(f),g++}else if(S.isRectAreaLight){const M=i.rectArea[_];M.position.setFromMatrixPosition(S.matrixWorld),M.position.applyMatrix4(f),o.identity(),a.copy(S.matrixWorld),a.premultiply(f),o.extractRotation(a),M.halfWidth.set(S.width*.5,0,0),M.halfHeight.set(0,S.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),_++}else if(S.isPointLight){const M=i.point[p];M.position.setFromMatrixPosition(S.matrixWorld),M.position.applyMatrix4(f),p++}else if(S.isHemisphereLight){const M=i.hemi[m];M.direction.setFromMatrixPosition(S.matrixWorld),M.direction.transformDirection(f),m++}}}return{setup:l,setupView:c,state:i}}function WebGLRenderState(s,e){const t=new WebGLLights(s,e),n=[],i=[];function r(){n.length=0,i.length=0}function a(u){n.push(u)}function o(u){i.push(u)}function l(u){t.setup(n,u)}function c(u){t.setupView(n,u)}return{init:r,state:{lightsArray:n,shadowsArray:i,lights:t},setupLights:l,setupLightsView:c,pushLight:a,pushShadow:o}}function WebGLRenderStates(s,e){let t=new WeakMap;function n(r,a=0){const o=t.get(r);let l;return o===void 0?(l=new WebGLRenderState(s,e),t.set(r,[l])):a>=o.length?(l=new WebGLRenderState(s,e),o.push(l)):l=o[a],l}function i(){t=new WeakMap}return{get:n,dispose:i}}class MeshDepthMaterial extends Material{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=BasicDepthPacking,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class MeshDistanceMaterial extends Material{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const vertex=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function _injectStyles(s){const e=document.createElement("style");e.innerHTML=s;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let stylesInjected=!1;class GUI{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:i,title:r="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!stylesInjected&&o&&(_injectStyles(stylesheet),stylesInjected=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=a}add(e,t,n,i,r){if(Object(n)===n)return new OptionController(this,e,t,n);const a=e[t];switch(typeof a){case"number":return new NumberController(this,e,t,n,i,r);case"boolean":return new BooleanController(this,e,t);case"string":return new StringController(this,e,t);case"function":return new FunctionController(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,a)}addColor(e,t,n=1){return new ColorController(this,e,t,n)}addFolder(e){const t=new GUI({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof FunctionController||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof FunctionController)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const GUI$1=GUI;class Debug{constructor(){this.active=window.location.hash==="#debug",this.active&&(this.ui=new GUI$1)}}class EventEmitter{constructor(){this.callbacks={},this.callbacks.base={}}on(e,t){return typeof e>"u"||e===""?(console.warn("wrong names"),!1):typeof t>"u"?(console.warn("wrong callback"),!1):(this.resolveNames(e).forEach(i=>{const r=this.resolveName(i);this.callbacks[r.namespace]instanceof Object||(this.callbacks[r.namespace]={}),this.callbacks[r.namespace][r.value]instanceof Array||(this.callbacks[r.namespace][r.value]=[]),this.callbacks[r.namespace][r.value].push(t)}),this)}off(e){return typeof e>"u"||e===""?(console.warn("wrong name"),!1):(this.resolveNames(e).forEach(n=>{const i=this.resolveName(n);if(i.namespace!=="base"&&i.value==="")delete this.callbacks[i.namespace];else if(i.namespace==="base")for(const r in this.callbacks)this.callbacks[r]instanceof Object&&this.callbacks[r][i.value]instanceof Array&&(delete this.callbacks[r][i.value],Object.keys(this.callbacks[r]).length===0&&delete this.callbacks[r]);else this.callbacks[i.namespace]instanceof Object&&this.callbacks[i.namespace][i.value]instanceof Array&&(delete this.callbacks[i.namespace][i.value],Object.keys(this.callbacks[i.namespace]).length===0&&delete this.callbacks[i.namespace])}),this)}trigger(e,t){if(typeof e>"u"||e==="")return console.warn("wrong name"),!1;let n=null;const i=t instanceof Array?t:[];let r=this.resolveNames(e);if(r=this.resolveName(r[0]),r.namespace==="base")for(const a in this.callbacks)this.callbacks[a]instanceof Object&&this.callbacks[a][r.value]instanceof Array&&this.callbacks[a][r.value].forEach(function(o){o.apply(this,i)});else if(this.callbacks[r.namespace]instanceof Object){if(r.value==="")return console.warn("wrong name"),this;this.callbacks[r.namespace][r.value].forEach(function(a){a.apply(this,i)})}return n}resolveNames(e){let t=e;return t=t.replace(/[^a-zA-Z0-9 ,/.]/g,""),t=t.replace(/[,/]+/g," "),t=t.split(" "),t}resolveName(e){const t={},n=e.split(".");return t.original=e,t.value=n[0],t.namespace="base",n.length>1&&n[1]!==""&&(t.namespace=n[1]),t}}class Sizes extends EventEmitter{constructor(){super(),this.width=window.innerWidth,this.height=window.innerHeight,this.pixelRatio=Math.min(window.devicePixelRatio,2),window.addEventListener("resize",()=>{this.width=window.innerWidth,this.height=window.innerHeight,this.pixelRatio=Math.min(window.devicePixelRatio,2),this.trigger("resize")})}}class Time extends EventEmitter{constructor(){super(),this.start=Date.now(),this.current=this.start,this.elapsed=0,this.delta=16,window.requestAnimationFrame(()=>{this.runFrame()})}runFrame(){const e=Date.now();this.delta=e-this.current,this.current=e,this.elapsed=this.current-this.start,this.trigger("runFrame"),window.requestAnimationFrame(()=>{this.runFrame()})}}const _changeEvent$1={type:"change"},_startEvent={type:"start"},_endEvent={type:"end"},_ray=new Ray,_plane=new Plane,TILT_LIMIT=Math.cos(70*MathUtils.DEG2RAD);class OrbitControls extends EventDispatcher{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new Vector3,this.cursor=new Vector3,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:MOUSE.ROTATE,MIDDLE:MOUSE.DOLLY,RIGHT:MOUSE.PAN},this.touches={ONE:TOUCH.ROTATE,TWO:TOUCH.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(R){R.addEventListener("keydown",T),this._domElementKeyEvents=R},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",T),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(_changeEvent$1),n.update(),r=i.NONE},this.update=function(){const R=new Vector3,ie=new Quaternion().setFromUnitVectors(e.up,new Vector3(0,1,0)),Y=ie.clone().invert(),xe=new Vector3,pe=new Quaternion,ve=new Vector3,de=2*Math.PI;return function(Ne=null){const L=n.object.position;R.copy(L).sub(n.target),R.applyQuaternion(ie),o.setFromVector3(R),n.autoRotate&&r===i.NONE&&V(y(Ne)),n.enableDamping?(o.theta+=l.theta*n.dampingFactor,o.phi+=l.phi*n.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let se=n.minAzimuthAngle,Q=n.maxAzimuthAngle;isFinite(se)&&isFinite(Q)&&(se<-Math.PI?se+=de:se>Math.PI&&(se-=de),Q<-Math.PI?Q+=de:Q>Math.PI&&(Q-=de),se<=Q?o.theta=Math.max(se,Math.min(Q,o.theta)):o.theta=o.theta>(se+Q)/2?Math.max(se,o.theta):Math.min(Q,o.theta)),o.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,o.phi)),o.makeSafe(),n.enableDamping===!0?n.target.addScaledVector(h,n.dampingFactor):n.target.add(h),n.target.sub(n.cursor),n.target.clampLength(n.minTargetRadius,n.maxTargetRadius),n.target.add(n.cursor),n.zoomToCursor&&A||n.object.isOrthographicCamera?o.radius=K(o.radius):o.radius=K(o.radius*c),R.setFromSpherical(o),R.applyQuaternion(Y),L.copy(n.target).add(R),n.object.lookAt(n.target),n.enableDamping===!0?(l.theta*=1-n.dampingFactor,l.phi*=1-n.dampingFactor,h.multiplyScalar(1-n.dampingFactor)):(l.set(0,0,0),h.set(0,0,0));let X=!1;if(n.zoomToCursor&&A){let ne=null;if(n.object.isPerspectiveCamera){const _e=R.length();ne=K(_e*c);const Ue=_e-ne;n.object.position.addScaledVector(S,Ue),n.object.updateMatrixWorld()}else if(n.object.isOrthographicCamera){const _e=new Vector3(M.x,M.y,0);_e.unproject(n.object),n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/c)),n.object.updateProjectionMatrix(),X=!0;const Ue=new Vector3(M.x,M.y,0);Ue.unproject(n.object),n.object.position.sub(Ue).add(_e),n.object.updateMatrixWorld(),ne=R.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),n.zoomToCursor=!1;ne!==null&&(this.screenSpacePanning?n.target.set(0,0,-1).transformDirection(n.object.matrix).multiplyScalar(ne).add(n.object.position):(_ray.origin.copy(n.object.position),_ray.direction.set(0,0,-1).transformDirection(n.object.matrix),Math.abs(n.object.up.dot(_ray.direction))<TILT_LIMIT?e.lookAt(n.target):(_plane.setFromNormalAndCoplanarPoint(n.object.up,n.target),_ray.intersectPlane(_plane,n.target))))}else n.object.isOrthographicCamera&&(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/c)),n.object.updateProjectionMatrix(),X=!0);return c=1,A=!1,X||xe.distanceToSquared(n.object.position)>a||8*(1-pe.dot(n.object.quaternion))>a||ve.distanceToSquared(n.target)>0?(n.dispatchEvent(_changeEvent$1),xe.copy(n.object.position),pe.copy(n.object.quaternion),ve.copy(n.target),X=!1,!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",J),n.domElement.removeEventListener("pointerdown",Re),n.domElement.removeEventListener("pointercancel",Fe),n.domElement.removeEventListener("wheel",C),n.domElement.removeEventListener("pointermove",we),n.domElement.removeEventListener("pointerup",Fe),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",T),n._domElementKeyEvents=null)};const n=this,i={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let r=i.NONE;const a=1e-6,o=new Spherical,l=new Spherical;let c=1;const h=new Vector3,u=new Vector2,d=new Vector2,p=new Vector2,g=new Vector2,_=new Vector2,m=new Vector2,f=new Vector2,x=new Vector2,v=new Vector2,S=new Vector3,M=new Vector2;let A=!1;const E=[],P={};function y(R){return R!==null?2*Math.PI/60*n.autoRotateSpeed*R:2*Math.PI/60/60*n.autoRotateSpeed}function w(){return Math.pow(.95,n.zoomSpeed)}function V(R){l.theta-=R}function W(R){l.phi-=R}const j=function(){const R=new Vector3;return function(Y,xe){R.setFromMatrixColumn(xe,0),R.multiplyScalar(-Y),h.add(R)}}(),D=function(){const R=new Vector3;return function(Y,xe){n.screenSpacePanning===!0?R.setFromMatrixColumn(xe,1):(R.setFromMatrixColumn(xe,0),R.crossVectors(n.object.up,R)),R.multiplyScalar(Y),h.add(R)}}(),O=function(){const R=new Vector3;return function(Y,xe){const pe=n.domElement;if(n.object.isPerspectiveCamera){const ve=n.object.position;R.copy(ve).sub(n.target);let de=R.length();de*=Math.tan(n.object.fov/2*Math.PI/180),j(2*Y*de/pe.clientHeight,n.object.matrix),D(2*xe*de/pe.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(j(Y*(n.object.right-n.object.left)/n.object.zoom/pe.clientWidth,n.object.matrix),D(xe*(n.object.top-n.object.bottom)/n.object.zoom/pe.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function $(R){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?c/=R:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function G(R){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?c*=R:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function Z(R){if(!n.zoomToCursor)return;A=!0;const ie=n.domElement.getBoundingClientRect(),Y=R.clientX-ie.left,xe=R.clientY-ie.top,pe=ie.width,ve=ie.height;M.x=Y/pe*2-1,M.y=-(xe/ve)*2+1,S.set(M.x,M.y,1).unproject(n.object).sub(n.object.position).normalize()}function K(R){return Math.max(n.minDistance,Math.min(n.maxDistance,R))}function q(R){u.set(R.clientX,R.clientY)}function I(R){Z(R),f.set(R.clientX,R.clientY)}function k(R){g.set(R.clientX,R.clientY)}function oe(R){d.set(R.clientX,R.clientY),p.subVectors(d,u).multiplyScalar(n.rotateSpeed);const ie=n.domElement;V(2*Math.PI*p.x/ie.clientHeight),W(2*Math.PI*p.y/ie.clientHeight),u.copy(d),n.update()}function ae(R){x.set(R.clientX,R.clientY),v.subVectors(x,f),v.y>0?$(w()):v.y<0&&G(w()),f.copy(x),n.update()}function le(R){_.set(R.clientX,R.clientY),m.subVectors(_,g).multiplyScalar(n.panSpeed),O(m.x,m.y),g.copy(_),n.update()}function Se(R){Z(R),R.deltaY<0?G(w()):R.deltaY>0&&$(w()),n.update()}function Ie(R){let ie=!1;switch(R.code){case n.keys.UP:R.ctrlKey||R.metaKey||R.shiftKey?W(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(0,n.keyPanSpeed),ie=!0;break;case n.keys.BOTTOM:R.ctrlKey||R.metaKey||R.shiftKey?W(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(0,-n.keyPanSpeed),ie=!0;break;case n.keys.LEFT:R.ctrlKey||R.metaKey||R.shiftKey?V(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(n.keyPanSpeed,0),ie=!0;break;case n.keys.RIGHT:R.ctrlKey||R.metaKey||R.shiftKey?V(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(-n.keyPanSpeed,0),ie=!0;break}ie&&(R.preventDefault(),n.update())}function Me(){if(E.length===1)u.set(E[0].pageX,E[0].pageY);else{const R=.5*(E[0].pageX+E[1].pageX),ie=.5*(E[0].pageY+E[1].pageY);u.set(R,ie)}}function Ae(){if(E.length===1)g.set(E[0].pageX,E[0].pageY);else{const R=.5*(E[0].pageX+E[1].pageX),ie=.5*(E[0].pageY+E[1].pageY);g.set(R,ie)}}function ke(){const R=E[0].pageX-E[1].pageX,ie=E[0].pageY-E[1].pageY,Y=Math.sqrt(R*R+ie*ie);f.set(0,Y)}function Le(){n.enableZoom&&ke(),n.enablePan&&Ae()}function U(){n.enableZoom&&ke(),n.enableRotate&&Me()}function qe(R){if(E.length==1)d.set(R.pageX,R.pageY);else{const Y=ce(R),xe=.5*(R.pageX+Y.x),pe=.5*(R.pageY+Y.y);d.set(xe,pe)}p.subVectors(d,u).multiplyScalar(n.rotateSpeed);const ie=n.domElement;V(2*Math.PI*p.x/ie.clientHeight),W(2*Math.PI*p.y/ie.clientHeight),u.copy(d)}function ge(R){if(E.length===1)_.set(R.pageX,R.pageY);else{const ie=ce(R),Y=.5*(R.pageX+ie.x),xe=.5*(R.pageY+ie.y);_.set(Y,xe)}m.subVectors(_,g).multiplyScalar(n.panSpeed),O(m.x,m.y),g.copy(_)}function Te(R){const ie=ce(R),Y=R.pageX-ie.x,xe=R.pageY-ie.y,pe=Math.sqrt(Y*Y+xe*xe);x.set(0,pe),v.set(0,Math.pow(x.y/f.y,n.zoomSpeed)),$(v.y),f.copy(x)}function Ee(R){n.enableZoom&&Te(R),n.enablePan&&ge(R)}function Ve(R){n.enableZoom&&Te(R),n.enableRotate&&qe(R)}function Re(R){n.enabled!==!1&&(E.length===0&&(n.domElement.setPointerCapture(R.pointerId),n.domElement.addEventListener("pointermove",we),n.domElement.addEventListener("pointerup",Fe)),te(R),R.pointerType==="touch"?F(R):He(R))}function we(R){n.enabled!==!1&&(R.pointerType==="touch"?ee(R):Xe(R))}function Fe(R){fe(R),E.length===0&&(n.domElement.releasePointerCapture(R.pointerId),n.domElement.removeEventListener("pointermove",we),n.domElement.removeEventListener("pointerup",Fe)),n.dispatchEvent(_endEvent),r=i.NONE}function He(R){let ie;switch(R.button){case 0:ie=n.mouseButtons.LEFT;break;case 1:ie=n.mouseButtons.MIDDLE;break;case 2:ie=n.mouseButtons.RIGHT;break;default:ie=-1}switch(ie){case MOUSE.DOLLY:if(n.enableZoom===!1)return;I(R),r=i.DOLLY;break;case MOUSE.ROTATE:if(R.ctrlKey||R.metaKey||R.shiftKey){if(n.enablePan===!1)return;k(R),r=i.PAN}else{if(n.enableRotate===!1)return;q(R),r=i.ROTATE}break;case MOUSE.PAN:if(R.ctrlKey||R.metaKey||R.shiftKey){if(n.enableRotate===!1)return;q(R),r=i.ROTATE}else{if(n.enablePan===!1)return;k(R),r=i.PAN}break;default:r=i.NONE}r!==i.NONE&&n.dispatchEvent(_startEvent)}function Xe(R){switch(r){case i.ROTATE:if(n.enableRotate===!1)return;oe(R);break;case i.DOLLY:if(n.enableZoom===!1)return;ae(R);break;case i.PAN:if(n.enablePan===!1)return;le(R);break}}function C(R){n.enabled===!1||n.enableZoom===!1||r!==i.NONE||(R.preventDefault(),n.dispatchEvent(_startEvent),Se(R),n.dispatchEvent(_endEvent))}function T(R){n.enabled===!1||n.enablePan===!1||Ie(R)}function F(R){switch(re(R),E.length){case 1:switch(n.touches.ONE){case TOUCH.ROTATE:if(n.enableRotate===!1)return;Me(),r=i.TOUCH_ROTATE;break;case TOUCH.PAN:if(n.enablePan===!1)return;Ae(),r=i.TOUCH_PAN;break;default:r=i.NONE}break;case 2:switch(n.touches.TWO){case TOUCH.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Le(),r=i.TOUCH_DOLLY_PAN;break;case TOUCH.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;U(),r=i.TOUCH_DOLLY_ROTATE;break;default:r=i.NONE}break;default:r=i.NONE}r!==i.NONE&&n.dispatchEvent(_startEvent)}function ee(R){switch(re(R),r){case i.TOUCH_ROTATE:if(n.enableRotate===!1)return;qe(R),n.update();break;case i.TOUCH_PAN:if(n.enablePan===!1)return;ge(R),n.update();break;case i.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Ee(R),n.update();break;case i.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Ve(R),n.update();break;default:r=i.NONE}}function J(R){n.enabled!==!1&&R.preventDefault()}function te(R){E.push(R)}function fe(R){delete P[R.pointerId];for(let ie=0;ie<E.length;ie++)if(E[ie].pointerId==R.pointerId){E.splice(ie,1);return}}function re(R){let ie=P[R.pointerId];ie===void 0&&(ie=new Vector2,P[R.pointerId]=ie),ie.set(R.pageX,R.pageY)}function ce(R){const ie=R.pointerId===E[0].pointerId?E[1]:E[0];return P[ie.pointerId]}n.domElement.addEventListener("contextmenu",J),n.domElement.addEventListener("pointerdown",Re),n.domElement.addEventListener("pointercancel",Fe),n.domElement.addEventListener("wheel",C,{passive:!1}),this.update()}}class Camera{constructor(){this.experience=new Experience,this.sizes=this.experience.sizes,this.scene=this.experience.scene,this.canvas=this.experience.canvas,this.setInstance()}setInstance(){this.instance=new PerspectiveCamera(80,this.sizes.width/this.sizes.height,.001,1e3),this.instance.position.set(1,0,0),this.instance.rotation.y=Math.PI/2,this.scene.add(this.instance)}setControls(){this.controls=new OrbitControls(this.instance,this.canvas),this.controls.enablePan=!1,this.controls.enableZoom=!1,this.controls.enableDamping=!0}activateControls(){}deactivateControls(){}resize(){this.instance.aspect=this.sizes.width/this.sizes.height,this.instance.updateProjectionMatrix()}update(){}}const CopyShader={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var _win,_doc,_docElement,_pluginInitted,_tempDiv,_recentSetterPlugin,_reverting,_windowExists=function s(){return typeof window<"u"},_transformProps={},_RAD2DEG=180/Math.PI,_DEG2RAD=Math.PI/180,_atan2=Math.atan2,_bigNum=1e8,_capsExp=/([A-Z])/g,_horizontalExp=/(left|right|width|margin|padding|x)/i,_complexExp=/[\s,\(]\S/,_propertyAliases={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},_renderCSSProp=function s(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},_renderPropWithEnd=function s(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},_renderCSSPropWithBeginning=function s(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},_renderRoundedCSSProp=function s(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},_renderNonTweeningValue=function s(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},_renderNonTweeningValueOnlyAtEnd=function s(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},_setterCSSStyle=function s(e,t,n){return e.style[t]=n},_setterCSSProp=function s(e,t,n){return e.style.setProperty(t,n)},_setterTransform=function s(e,t,n){return e._gsap[t]=n},_setterScale=function s(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},_setterScaleWithRender=function s(e,t,n,i,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},_setterTransformWithRender=function s(e,t,n,i,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},_transformProp="transform",_transformOriginProp=_transformProp+"Origin",_saveStyle=function s(e,t){var n=this,i=this.target,r=i.style,a=i._gsap;if(e in _transformProps&&r){if(this.tfm=this.tfm||{},e!=="transform")e=_propertyAliases[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=_get(i,o)}):this.tfm[e]=a.x?a[e]:_get(i,e),e===_transformOriginProp&&(this.tfm.zOrigin=a.zOrigin);else return _propertyAliases.transform.split(",").forEach(function(o){return s.call(n,o,t)});if(this.props.indexOf(_transformProp)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(_transformOriginProp,t,"")),e=_transformProp}(r||t)&&this.props.push(e,t,r[e])},_removeIndependentTransforms=function s(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},_revertStyle=function s(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(_capsExp,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=_reverting(),(!r||!r.isStart)&&!n[_transformProp]&&(_removeIndependentTransforms(n),i.zOrigin&&n[_transformOriginProp]&&(n[_transformOriginProp]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},_getStyleSaver=function s(e,t){var n={target:e,props:[],revert:_revertStyle,save:_saveStyle};return e._gsap||gsap.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},_supports3D,_createElement=function s(e,t){var n=_doc.createElementNS?_doc.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):_doc.createElement(e);return n&&n.style?n:_doc.createElement(e)},_getComputedProperty=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(_capsExp,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,_checkPropPrefix(t)||t,1)||""},_prefixes="O,Moz,ms,Ms,Webkit".split(","),_checkPropPrefix=function s(e,t,n){var i=t||_tempDiv,r=i.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(_prefixes[a]+e in r););return a<0?null:(a===3?"ms":a>=0?_prefixes[a]:"")+e},_initCore=function s(){_windowExists()&&window.document&&(_win=window,_doc=_win.document,_docElement=_doc.documentElement,_tempDiv=_createElement("div")||{style:{}},_createElement("div"),_transformProp=_checkPropPrefix(_transformProp),_transformOriginProp=_transformProp+"Origin",_tempDiv.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",_supports3D=!!_checkPropPrefix("perspective"),_reverting=gsap.core.reverting,_pluginInitted=1)},_getBBoxHack=function s(e){var t=_createElement("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,r=this.style.cssText,a;if(_docElement.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=s}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),_docElement.removeChild(t),this.style.cssText=r,a},_getAttributeFallbacks=function s(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},_getBBox=function s(e){var t;try{t=e.getBBox()}catch{t=_getBBoxHack.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===_getBBoxHack||(t=_getBBoxHack.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+_getAttributeFallbacks(e,["x","cx","x1"])||0,y:+_getAttributeFallbacks(e,["y","cy","y1"])||0,width:0,height:0}:t},_isSVG=function s(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&_getBBox(e))},_removeProperty=function s(e,t){if(t){var n=e.style,i;t in _transformProps&&t!==_transformOriginProp&&(t=_transformProp),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(_capsExp,"-$1").toLowerCase())):n.removeAttribute(t)}},_addNonTweeningPT=function s(e,t,n,i,r,a){var o=new PropTween(e._pt,t,n,0,1,a?_renderNonTweeningValueOnlyAtEnd:_renderNonTweeningValue);return e._pt=o,o.b=i,o.e=r,e._props.push(n),o},_nonConvertibleUnits={deg:1,rad:1,turn:1},_nonStandardLayouts={grid:1,flex:1},_convertToUnit=function s(e,t,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=_tempDiv.style,l=_horizontalExp.test(t),c=e.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",p=i==="%",g,_,m,f;if(i===a||!r||_nonConvertibleUnits[i]||_nonConvertibleUnits[a])return r;if(a!=="px"&&!d&&(r=s(e,t,n,"px")),f=e.getCTM&&_isSVG(e),(p||a==="%")&&(_transformProps[t]||~t.indexOf("adius")))return g=f?e.getBBox()[l?"width":"height"]:e[h],_round(p?r/g*u:r/100*g);if(o[l?"width":"height"]=u+(d?a:i),_=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,f&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===_doc||!_.appendChild)&&(_=_doc.body),m=_._gsap,m&&p&&m.width&&l&&m.time===_ticker.time&&!m.uncache)return _round(r/m.width*u);if(p&&(t==="height"||t==="width")){var x=e.style[t];e.style[t]=u+i,g=e[h],x?e.style[t]=x:_removeProperty(e,t)}else(p||a==="%")&&!_nonStandardLayouts[_getComputedProperty(_,"display")]&&(o.position=_getComputedProperty(e,"position")),_===e&&(o.position="static"),_.appendChild(_tempDiv),g=_tempDiv[h],_.removeChild(_tempDiv),o.position="absolute";return l&&p&&(m=_getCache(_),m.time=_ticker.time,m.width=_[h]),_round(d?g*r/u:g&&r?u/g*r:0)},_get=function s(e,t,n,i){var r;return _pluginInitted||_initCore(),t in _propertyAliases&&t!=="transform"&&(t=_propertyAliases[t],~t.indexOf(",")&&(t=t.split(",")[0])),_transformProps[t]&&t!=="transform"?(r=_parseTransform(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:_firstTwoOnly(_getComputedProperty(e,_transformOriginProp))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=_specialProps[t]&&_specialProps[t](e,t,n)||_getComputedProperty(e,t)||_getProperty(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?_convertToUnit(e,t,r,n)+n:r},_tweenComplexCSSString=function s(e,t,n,i){if(!n||n==="none"){var r=_checkPropPrefix(t,e,1),a=r&&_getComputedProperty(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=_getComputedProperty(e,"borderTopColor"))}var o=new PropTween(this._pt,e.style,t,0,1,_renderComplexString),l=0,c=0,h,u,d,p,g,_,m,f,x,v,S,M;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=e.style[t],e.style[t]=i,i=_getComputedProperty(e,t)||i,_?e.style[t]=_:_removeProperty(e,t)),h=[n,i],_colorStringFilter(h),n=h[0],i=h[1],d=n.match(_numWithUnitExp)||[],M=i.match(_numWithUnitExp)||[],M.length){for(;u=_numWithUnitExp.exec(i);)m=u[0],x=i.substring(l,u.index),g?g=(g+1)%5:(x.substr(-5)==="rgba("||x.substr(-5)==="hsla(")&&(g=1),m!==(_=d[c++]||"")&&(p=parseFloat(_)||0,S=_.substr((p+"").length),m.charAt(1)==="="&&(m=_parseRelative(p,m)+S),f=parseFloat(m),v=m.substr((f+"").length),l=_numWithUnitExp.lastIndex-v.length,v||(v=v||_config.units[t]||S,l===i.length&&(i+=v,o.e+=v)),S!==v&&(p=_convertToUnit(e,t,_,v)||0),o._pt={_next:o._pt,p:x||c===1?x:",",s:p,c:f-p,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?_renderNonTweeningValueOnlyAtEnd:_renderNonTweeningValue;return _relExp.test(i)&&(o.e=0),this._pt=o,o},_keywordToPercent={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},_convertKeywordsToPercentages=function s(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=_keywordToPercent[n]||n,t[1]=_keywordToPercent[i]||i,t.join(" ")},_renderClearProps=function s(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],_transformProps[o]&&(l=1,o=o==="transformOrigin"?_transformOriginProp:_transformProp),_removeProperty(n,o);l&&(_removeProperty(n,_transformProp),a&&(a.svg&&n.removeAttribute("transform"),_parseTransform(n,1),a.uncache=1,_removeIndependentTransforms(i)))}},_specialProps={clearProps:function s(e,t,n,i,r){if(r.data!=="isFromStart"){var a=e._pt=new PropTween(e._pt,t,n,0,0,_renderClearProps);return a.u=i,a.pr=-10,a.tween=r,e._props.push(n),1}}},_identity2DMatrix=[1,0,0,1,0,0],_rotationalProperties={},_isNullTransform=function s(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},_getComputedTransformMatrixAsArray=function s(e){var t=_getComputedProperty(e,_transformProp);return _isNullTransform(t)?_identity2DMatrix:t.substr(7).match(_numExp).map(_round)},_getMatrix=function s(e,t){var n=e._gsap||_getCache(e),i=e.style,r=_getComputedTransformMatrixAsArray(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?_identity2DMatrix:r):(r===_identity2DMatrix&&!e.offsetParent&&e!==_docElement&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,_docElement.appendChild(e)),r=_getComputedTransformMatrixAsArray(e),l?i.display=l:_removeProperty(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):_docElement.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},_applySVGOrigin=function s(e,t,n,i,r,a){var o=e._gsap,l=r||_getMatrix(e,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],f=l[4],x=l[5],v=t.split(" "),S=parseFloat(v[0])||0,M=parseFloat(v[1])||0,A,E,P,y;n?l!==_identity2DMatrix&&(E=p*m-g*_)&&(P=S*(m/E)+M*(-_/E)+(_*x-m*f)/E,y=S*(-g/E)+M*(p/E)-(p*x-g*f)/E,S=P,M=y):(A=_getBBox(e),S=A.x+(~v[0].indexOf("%")?S/100*A.width:S),M=A.y+(~(v[1]||v[0]).indexOf("%")?M/100*A.height:M)),i||i!==!1&&o.smooth?(f=S-c,x=M-h,o.xOffset=u+(f*p+x*_)-f,o.yOffset=d+(f*g+x*m)-x):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=M,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[_transformOriginProp]="0px 0px",a&&(_addNonTweeningPT(a,o,"xOrigin",c,S),_addNonTweeningPT(a,o,"yOrigin",h,M),_addNonTweeningPT(a,o,"xOffset",u,o.xOffset),_addNonTweeningPT(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",S+" "+M)},_parseTransform=function s(e,t){var n=e._gsap||new GSCache(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=_getComputedProperty(e,_transformOriginProp)||"0",h,u,d,p,g,_,m,f,x,v,S,M,A,E,P,y,w,V,W,j,D,O,$,G,Z,K,q,I,k,oe,ae,le;return h=u=d=_=m=f=x=v=S=0,p=g=1,n.svg=!!(e.getCTM&&_isSVG(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[_transformProp]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[_transformProp]!=="none"?l[_transformProp]:"")),i.scale=i.rotate=i.translate="none"),E=_getMatrix(e,n.svg),n.svg&&(n.uncache?(Z=e.getBBox(),c=n.xOrigin-Z.x+"px "+(n.yOrigin-Z.y)+"px",G=""):G=!t&&e.getAttribute("data-svg-origin"),_applySVGOrigin(e,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,E)),M=n.xOrigin||0,A=n.yOrigin||0,E!==_identity2DMatrix&&(V=E[0],W=E[1],j=E[2],D=E[3],h=O=E[4],u=$=E[5],E.length===6?(p=Math.sqrt(V*V+W*W),g=Math.sqrt(D*D+j*j),_=V||W?_atan2(W,V)*_RAD2DEG:0,x=j||D?_atan2(j,D)*_RAD2DEG+_:0,x&&(g*=Math.abs(Math.cos(x*_DEG2RAD))),n.svg&&(h-=M-(M*V+A*j),u-=A-(M*W+A*D))):(le=E[6],oe=E[7],q=E[8],I=E[9],k=E[10],ae=E[11],h=E[12],u=E[13],d=E[14],P=_atan2(le,k),m=P*_RAD2DEG,P&&(y=Math.cos(-P),w=Math.sin(-P),G=O*y+q*w,Z=$*y+I*w,K=le*y+k*w,q=O*-w+q*y,I=$*-w+I*y,k=le*-w+k*y,ae=oe*-w+ae*y,O=G,$=Z,le=K),P=_atan2(-j,k),f=P*_RAD2DEG,P&&(y=Math.cos(-P),w=Math.sin(-P),G=V*y-q*w,Z=W*y-I*w,K=j*y-k*w,ae=D*w+ae*y,V=G,W=Z,j=K),P=_atan2(W,V),_=P*_RAD2DEG,P&&(y=Math.cos(P),w=Math.sin(P),G=V*y+W*w,Z=O*y+$*w,W=W*y-V*w,$=$*y-O*w,V=G,O=Z),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,f=180-f),p=_round(Math.sqrt(V*V+W*W+j*j)),g=_round(Math.sqrt($*$+le*le)),P=_atan2(O,$),x=Math.abs(P)>2e-4?P*_RAD2DEG:0,S=ae?1/(ae<0?-ae:ae):0),n.svg&&(G=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!_isNullTransform(_getComputedProperty(e,_transformProp)),G&&e.setAttribute("transform",G))),Math.abs(x)>90&&Math.abs(x)<270&&(r?(p*=-1,x+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,x+=x<=0?180:-180)),t=t||n.uncache,n.x=h-((n.xPercent=h&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-h)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=_round(p),n.scaleY=_round(g),n.rotation=_round(_)+o,n.rotationX=_round(m)+o,n.rotationY=_round(f)+o,n.skewX=x+o,n.skewY=v+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[_transformOriginProp]=_firstTwoOnly(c)),n.xOffset=n.yOffset=0,n.force3D=_config.force3D,n.renderTransform=n.svg?_renderSVGTransforms:_supports3D?_renderCSSTransforms:_renderNon3DTransforms,n.uncache=0,n},_firstTwoOnly=function s(e){return(e=e.split(" "))[0]+" "+e[1]},_addPxTranslate=function s(e,t,n){var i=getUnit(t);return _round(parseFloat(t)+parseFloat(_convertToUnit(e,"x",n+"px",i)))+i},_renderNon3DTransforms=function s(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,_renderCSSTransforms(e,t)},_zeroDeg="0deg",_zeroPx="0px",_endParenthesis=") ",_renderCSSTransforms=function s(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,f=n.force3D,x=n.target,v=n.zOrigin,S="",M=f==="auto"&&e&&e!==1||f===!0;if(v&&(u!==_zeroDeg||h!==_zeroDeg)){var A=parseFloat(h)*_DEG2RAD,E=Math.sin(A),P=Math.cos(A),y;A=parseFloat(u)*_DEG2RAD,y=Math.cos(A),a=_addPxTranslate(x,a,E*y*-v),o=_addPxTranslate(x,o,-Math.sin(A)*-v),l=_addPxTranslate(x,l,P*y*-v+v)}m!==_zeroPx&&(S+="perspective("+m+_endParenthesis),(i||r)&&(S+="translate("+i+"%, "+r+"%) "),(M||a!==_zeroPx||o!==_zeroPx||l!==_zeroPx)&&(S+=l!==_zeroPx||M?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+_endParenthesis),c!==_zeroDeg&&(S+="rotate("+c+_endParenthesis),h!==_zeroDeg&&(S+="rotateY("+h+_endParenthesis),u!==_zeroDeg&&(S+="rotateX("+u+_endParenthesis),(d!==_zeroDeg||p!==_zeroDeg)&&(S+="skew("+d+", "+p+_endParenthesis),(g!==1||_!==1)&&(S+="scale("+g+", "+_+_endParenthesis),x.style[_transformProp]=S||"translate(0, 0)"},_renderSVGTransforms=function s(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,f=n.yOffset,x=n.forceCSS,v=parseFloat(a),S=parseFloat(o),M,A,E,P,y;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=_DEG2RAD,c*=_DEG2RAD,M=Math.cos(l)*u,A=Math.sin(l)*u,E=Math.sin(l-c)*-d,P=Math.cos(l-c)*d,c&&(h*=_DEG2RAD,y=Math.tan(c-h),y=Math.sqrt(1+y*y),E*=y,P*=y,h&&(y=Math.tan(h),y=Math.sqrt(1+y*y),M*=y,A*=y)),M=_round(M),A=_round(A),E=_round(E),P=_round(P)):(M=u,P=d,A=E=0),(v&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(v=_convertToUnit(p,"x",a,"px"),S=_convertToUnit(p,"y",o,"px")),(g||_||m||f)&&(v=_round(v+g-(g*M+_*E)+m),S=_round(S+_-(g*A+_*P)+f)),(i||r)&&(y=p.getBBox(),v=_round(v+i/100*y.width),S=_round(S+r/100*y.height)),y="matrix("+M+","+A+","+E+","+P+","+v+","+S+")",p.setAttribute("transform",y),x&&(p.style[_transformProp]=y)},_addRotationalPropTween=function s(e,t,n,i,r){var a=360,o=_isString(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?_RAD2DEG:1),c=l-i,h=i+c+"deg",u,d;return o&&(u=r.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*_bigNum)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*_bigNum)%a-~~(c/a)*a)),e._pt=d=new PropTween(e._pt,t,n,i,c,_renderPropWithEnd),d.e=h,d.u="deg",e._props.push(n),d},_assign=function s(e,t){for(var n in t)e[n]=t[n];return e},_addRawTransformPTs=function s(e,t,n){var i=_assign({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,d,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[_transformProp]=t,o=_parseTransform(n,1),_removeProperty(n,_transformProp),n.setAttribute("transform",c)):(c=getComputedStyle(n)[_transformProp],a[_transformProp]=t,o=_parseTransform(n,1),a[_transformProp]=c);for(l in _transformProps)c=i[l],h=o[l],c!==h&&r.indexOf(l)<0&&(p=getUnit(c),g=getUnit(h),u=p!==g?_convertToUnit(n,l,c,g):parseFloat(c),d=parseFloat(h),e._pt=new PropTween(e._pt,o,l,u,d-u,_renderCSSProp),e._pt.u=g||0,e._props.push(l));_assign(o,i)};_forEachName("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",a=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(o){return e<2?s+o:"border"+o+s});_specialProps[e>1?"border"+s:s]=function(o,l,c,h,u){var d,p;if(arguments.length<4)return d=a.map(function(g){return _get(o,g,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(h+"").split(" "),p={},a.forEach(function(g,_){return p[g]=d[_]=d[_]||d[(_-1)/2|0]}),o.init(l,p,u)}});var CSSPlugin={name:"css",register:_initCore,targetTest:function s(e){return e.style&&e.nodeType},init:function s(e,t,n,i,r){var a=this._props,o=e.style,l=n.vars.startAt,c,h,u,d,p,g,_,m,f,x,v,S,M,A,E,P;_pluginInitted||_initCore(),this.styles=this.styles||_getStyleSaver(e),P=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(h=t[_],!(_plugins[_]&&_checkPlugin(_,t,n,i,e,r)))){if(p=typeof h,g=_specialProps[_],p==="function"&&(h=h.call(n,i,e,r),p=typeof h),p==="string"&&~h.indexOf("random(")&&(h=_replaceRandom(h)),g)g(this,e,_,h,n)&&(E=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(_)+"").trim(),h+="",_colorExp.lastIndex=0,_colorExp.test(c)||(m=getUnit(c),f=getUnit(h)),f?m!==f&&(c=_convertToUnit(e,_,c,f)+f):m&&(h+=m),this.add(o,"setProperty",c,h,i,r,0,0,_),a.push(_),P.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,e,r):l[_],_isString(c)&&~c.indexOf("random(")&&(c=_replaceRandom(c)),getUnit(c+"")||c==="auto"||(c+=_config.units[_]||getUnit(_get(e,_))||""),(c+"").charAt(1)==="="&&(c=_get(e,_))):c=_get(e,_),d=parseFloat(c),x=p==="string"&&h.charAt(1)==="="&&h.substr(0,2),x&&(h=h.substr(2)),u=parseFloat(h),_ in _propertyAliases&&(_==="autoAlpha"&&(d===1&&_get(e,"visibility")==="hidden"&&u&&(d=0),P.push("visibility",0,o.visibility),_addNonTweeningPT(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=_propertyAliases[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in _transformProps,v){if(this.styles.save(_),S||(M=e._gsap,M.renderTransform&&!t.parseTransform||_parseTransform(e,t.parseTransform),A=t.smoothOrigin!==!1&&M.smooth,S=this._pt=new PropTween(this._pt,o,_transformProp,0,1,M.renderTransform,M,0,-1),S.dep=1),_==="scale")this._pt=new PropTween(this._pt,M,"scaleY",M.scaleY,(x?_parseRelative(M.scaleY,x+u):u)-M.scaleY||0,_renderCSSProp),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){P.push(_transformOriginProp,0,o[_transformOriginProp]),h=_convertKeywordsToPercentages(h),M.svg?_applySVGOrigin(e,h,0,A,0,this):(f=parseFloat(h.split(" ")[2])||0,f!==M.zOrigin&&_addNonTweeningPT(this,M,"zOrigin",M.zOrigin,f),_addNonTweeningPT(this,o,_,_firstTwoOnly(c),_firstTwoOnly(h)));continue}else if(_==="svgOrigin"){_applySVGOrigin(e,h,1,A,0,this);continue}else if(_ in _rotationalProperties){_addRotationalPropTween(this,M,_,d,x?_parseRelative(d,x+h):h);continue}else if(_==="smoothOrigin"){_addNonTweeningPT(this,M,"smooth",M.smooth,h);continue}else if(_==="force3D"){M[_]=h;continue}else if(_==="transform"){_addRawTransformPTs(this,h,e);continue}}else _ in o||(_=_checkPropPrefix(_)||_);if(v||(u||u===0)&&(d||d===0)&&!_complexExp.test(h)&&_ in o)m=(c+"").substr((d+"").length),u||(u=0),f=getUnit(h)||(_ in _config.units?_config.units[_]:m),m!==f&&(d=_convertToUnit(e,_,c,f)),this._pt=new PropTween(this._pt,v?M:o,_,d,(x?_parseRelative(d,x+u):u)-d,!v&&(f==="px"||_==="zIndex")&&t.autoRound!==!1?_renderRoundedCSSProp:_renderCSSProp),this._pt.u=f||0,m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=_renderCSSPropWithBeginning);else if(_ in o)_tweenComplexCSSString.call(this,e,_,c,x?x+h:h);else if(_ in e)this.add(e,_,c||e[_],x?x+h:h,i,r);else if(_!=="parseTransform"){_missingPlugin(_,h);continue}v||(_ in o?P.push(_,0,o[_]):P.push(_,1,c||e[_])),a.push(_)}}E&&_sortPropTweensByPriority(this)},render:function s(e,t){if(t.tween._time||!_reverting())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:_get,aliases:_propertyAliases,getSetter:function s(e,t,n){var i=_propertyAliases[t];return i&&i.indexOf(",")<0&&(t=i),t in _transformProps&&t!==_transformOriginProp&&(e._gsap.x||_get(e,"x"))?n&&_recentSetterPlugin===n?t==="scale"?_setterScale:_setterTransform:(_recentSetterPlugin=n||{})&&(t==="scale"?_setterScaleWithRender:_setterTransformWithRender):e.style&&!_isUndefined(e.style[t])?_setterCSSStyle:~t.indexOf("-")?_setterCSSProp:_getSetter(e,t)},core:{_removeProperty,_getMatrix}};gsap.utils.checkPrefix=_checkPropPrefix;gsap.core.getStyleSaver=_getStyleSaver;(function(s,e,t,n){var i=_forEachName(s+","+e+","+t,function(r){_transformProps[r]=1});_forEachName(e,function(r){_config.units[r]="deg",_rotationalProperties[r]=1}),_propertyAliases[i[13]]=s+","+e,_forEachName(n,function(r){var a=r.split(":");_propertyAliases[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");_forEachName("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){_config.units[s]="px"});gsap.registerPlugin(CSSPlugin);var gsapWithCSS=gsap.registerPlugin(CSSPlugin)||gsap;gsapWithCSS.core.Tween;class Hotspot extends BaseElement{constructor(e,t=-131,n=-15,i=5,r=5){super(e);let a=t,o=n,l=i,c=r;this.experience=new Experience,this.time=this.experience.time,this.mesh=new Mesh(new PlaneGeometry(l,c,4,4),new MeshPhongMaterial({color:"red",side:DoubleSide,transparent:!0,opacity:.8,depthWrite:!0,depthTest:!1})),this.mesh.position.x=-40,this.element.rotation.y=a*(Math.PI/180),this.element.rotation.x=o*(Math.PI/180),this.element.add(this.mesh),this.mesh.name=e,this.mousePosition=new Vector2,this.raycaster=new Raycaster;let h=this;addEventListener("click",u=>{if(!this.experience.active||this.active)return;h.mousePosition.x=u.clientX/window.innerWidth*2-1,h.mousePosition.y=-(u.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(h.mousePosition,this.experience.camera.instance);const d=this.raycaster.intersectObjects(this.experience.scene.children);d.length>0&&(console.log(d[0].object.name),d[0].object.name===this.mesh.name&&this.trigger("hotspot_click"))}),addEventListener("mousemove",u=>{this.experience.active&&(h.mousePosition.x=u.clientX/window.innerWidth*2-1,h.mousePosition.y=-(u.clientY/window.innerHeight)*2+1)}),this.time.on("runFrame",()=>{this.update()})}update(){if(!this.experience.active)return;this.mesh.lookAt(this.experience.camera.instance.position),this.raycaster.setFromCamera(this.mousePosition,this.experience.camera.instance);const e=this.raycaster.intersectObjects(this.experience.scene.children);for(let t=0;t<e.length;t++)e[t].object.name,this.mesh.name}}class ModelElement extends BaseElement{constructor(e,t,n=null){super(e),this.hasAnimations=!1,t!=null&&(this.resource=t,this.resourceAnimations=n,this.setElement(this.resource),n!=null&&(this.hasAnimations=!0,this.resourceAnimations.length>0&&this.setAnimation()))}setElement(e=null){e!=null&&this.setModel(e)}setModel(e){this.clonedresource=this.cloneGltf(e),this.model=this.clonedresource.scene,this.model.traverse(t=>{t instanceof Mesh&&(t.name==="Plane001"&&(t.receiveShadow=!0),t.castShadow=!0)}),this.addToScene(this.model)}setAnimation(){this.animation={},this.animation.mixer=new AnimationMixer(this.model),this.animation.actions={},this.animation.actionList=[],this.resourceAnimations.forEach(e=>{let t=this.clonedresource.animations.find(({name:n})=>n===e);this.animation.actions[e]=this.animation.mixer.clipAction(t),this.animation.mixer.clipAction(t).name=e,this.animation.actionList.push(this.animation.mixer.clipAction(t))}),this.animation.actions.current=this.animation.actionList[0],this.animation.play=e=>{const t=this.animation.actionList.find(({name:i})=>i===e),n=this.animation.actions.current;t.loop=LoopPingPong,t.reset(),t.play(),t.crossFadeFrom(n,1),this.animation.actions.current=t},this.animation.stop=()=>{this.animation.actions.current.fadeOut(1)}}playAnimation(e){this.animation.play(e)}updateAnim(){this.hasAnimations&&this.animation.mixer.update(this.time.delta*5e-4)}cloneGltf(e){const t={animations:e.animations,scene:e.scene.clone(!0)},n={};e.scene.traverse(a=>{a.isSkinnedMesh&&(n[a.name]=a)});const i={},r={};t.scene.traverse(a=>{a.isBone&&(i[a.name]=a),a.isSkinnedMesh&&(r[a.name]=a)});for(let a in n){const l=n[a].skeleton,c=r[a],h=[];for(let u=0;u<l.bones.length;++u){const d=i[l.bones[u].name];h.push(d)}c.bind(new Skeleton(h,l.boneInverses),c.matrixWorld)}return t}}class Stage{constructor(){this.experience=new Experience,this.scene=this.experience.scene,this.stageResources=new Resources(stageSources),this.stageObjects=new Group,this.experience.preloader.active,this.stageResources.on("ready",()=>{this.environment=new Environment,this.pack01=new ModelElement("pack01",this.stageResources.items.pack01),this.stageObjects.add(this.pack01.element),this.pack02=new ModelElement("pack02",this.stageResources.items.pack02),this.stageObjects.add(this.pack02.element),this.pack03=new ModelElement("pack03",this.stageResources.items.pack03),this.stageObjects.add(this.pack03.element),this.stageObjects.scale.x=20,this.stageObjects.scale.y=20,this.stageObjects.scale.z=20,this.stageObjects.position.set(-10,-10,0),this.planeGroup=new Group,this.pgeometry=new PlaneGeometry(5,3),this.pmaterial=new MeshBasicMaterial({color:16777215,side:FrontSide,transparent:!0,opacity:.5}),this.planeGroup.position.copy(this.experience.camera.instance.position),this.hotspot1=new Hotspot("hotspot1",-131,-15,5,5),this.hotspot1.setPosition(0,-2,0)})}update(){this.plane&&this.plane.update(),this.stagePanorama&&this.stagePanorama.update(),this.pplane,this.stageObjects.lookAt(this.experience.camera.instance.position)}hideScene(){this.experience.camera.deactivateControls(),this.experience.preloader.show(),this.experience.preloader.on("pHidden",()=>{this.scene.remove(this.stageObjects)})}showScene(){this.scene.add(this.stageObjects),this.experience.camera.activateControls(),this.experience.preloader.hide("hideVideoIntro",3)}}const sources=[{name:"environmentMapTexture",type:"cubeTexture",path:["textures/environmentMap/px.jpg","textures/environmentMap/nx.jpg","textures/environmentMap/py.jpg","textures/environmentMap/ny.jpg","textures/environmentMap/pz.jpg","textures/environmentMap/nz.jpg"]},{name:"grassColorTexture",type:"texture",path:"textures/dirt/color.jpg"},{name:"grassNormalTexture",type:"texture",path:"textures/dirt/normal.jpg"}];class UserCam extends EventEmitter{constructor(e){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.cameraContainer=document.getElementById(e),this.streaming=!1,this.mediaStream=null,this.constraints={audio:!1,video:{width:{min:640,ideal:1920},height:{min:400,ideal:1080},aspectRatio:{ideal:1.7777777778},facingMode:"environment"}}}hide(){this.video.style.display="none"}show(){this.video.style.display="flex"}async init(){this.video=document.createElement("video"),this.video.style.display="none",this.video.setAttribute("webkit-playsinline","webkit-playsinline"),this.video.setAttribute("playsinline",""),this.cameraContainer.appendChild(this.video),await this.getMediaStream(this.constraints),this.resize()}async getMediaStream(e){try{this.mediaStream=await navigator.mediaDevices.getUserMedia(e),this.video.srcObject=this.mediaStream,this.video.onloadedmetadata=t=>{this.video.play()}}catch(t){console.error(t.message)}}resize(){this.video.style.width=window.innerWidth,this.video.style.height=window.innerHeight;let e=this.sizes.width/this.sizes.height,t=this.mediaStream.getVideoTracks()[0].getSettings().width/this.mediaStream.getVideoTracks()[0].getSettings().height;this.video.style.position="relative",this.video.style.left="0px",this.video.style.top="0px",e<1?this.video.style.left=`-${(this.mediaStream.getVideoTracks()[0].getSettings().width-window.innerHeight*t)/2}px`:(this.video.style.width=window.innerWidth,this.video.style.height=window.innerWidth/t)}}class Preloader extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.camera=this.experience.camera,this.scene=this.experience.scene,this.canvas=this.experience.canvas,this.active=!0,this.transitionTime=.3,this.overlayGeometry=new PlaneGeometry(20,20,1,1),this.testMaterial=new MeshLambertMaterial({color:255,transparent:!0,opacity:.5}),this.overlayMaterial=new ShaderMaterial({transparent:!0,depthTest:!0,depthWrite:!1,uniforms:{uAlpha:{value:1}},vertexShader:`
                void main()
                {
                    gl_Position = vec4(position, 1.0);
                }
            ...
            `}),this.overlay=new Mesh(this.overlayGeometry,this.overlayMaterial),this.overlay.name="preloaderScreen",this.overlay.rotation.y=Math.PI/2,this.fastShow(),this.scene.add(this.overlay)}fastShow(){this.scene.add(this.overlay),gsapWithCSS.set(this.overlayMaterial.uniforms.uAlpha,{value:1}),this.active=!0}show(e,t=this.transitionTime){this.scene.add(this.overlay),gsapWithCSS.to(this.overlayMaterial.uniforms.uAlpha,{duration:t,value:1,delay:0,onComplete:()=>{switch(e){case"ageGate":this.trigger("shwoAgeGate");break;case"concertShow":this.trigger("concertShow");break;case"videoIntro":this.trigger("shwoVideoIntro");break;case"pshow_ar":this.trigger("pshow_ar");break;case"video01_end":this.trigger("video01_end");break}}}),this.active=!0}hide(e,t=this.transitionTime){gsapWithCSS.to(this.overlayMaterial.uniforms.uAlpha,{duration:t,value:0,delay:0,onComplete:()=>{switch(this.active=!1,this.scene.remove(this.overlay),e){case"showAgeGate":this.trigger("showAgeGate");break;case"ageGate":this.trigger("hideAgeGate");break;case"videoIntro":this.trigger("hideVideoIntro");break;case"homehide":this.experience.cameraControl.active=!0,this.trigger("homePreloaderHide");break;case"phide_ar":this.trigger("phide_ar");break;case"phide_arScene":this.trigger("phide_arScene");break;case"load_hide":this.trigger("load_hide");break}}})}update(){}}class VideoScreen extends EventEmitter{constructor(){super(),this.experience=new Experience,this.loaded=!1,this.playing=!1,this.active=!1,this.video=document.getElementById("videoTag"),this.video.height=window.innerHeight,this.video.width=window.innerWidth;let e=this;this.video.addEventListener("loadeddata",function(){e.loaded=!0,e.resize()},!1)}play(){console.log("video play"),this.playLoadedVideo()}playLoadedVideo(){this.playing=!0,this.resize(),this.video.style.display="flex",this.video.play(),this.video.onended=e=>{this.trigger("videoCompleted")}}hide(){this.playing=!1,this.video.style.display="none"}update(){this.playing}resize(){if(this.playing){let e=this.video.videoWidth/this.video.videoHeight;window.innerWidth/window.innerHeight<e?(this.video.setAttribute("width",window.innerHeight*e),this.video.setAttribute("height",window.innerHeight)):(this.video.setAttribute("width",window.innerWidth),this.video.setAttribute("height",window.innerWidth/e))}}}class AgeGate extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.pageContainer=document.getElementById("experienceContainer"),this.pageContent=document.createElement("div"),this.pageContent.className="fullscreen-div",this.boton1=document.createElement("button"),this.boton1.textContent="Soy Mayor",this.boton1.onclick=()=>{this.trigger("ageOk")},this.boton2=document.createElement("button"),this.boton2.textContent="Soy Menor",this.boton2.onclick=()=>{this.trigger("ageNotOk")},this.pageContent.appendChild(this.boton1),this.pageContent.appendChild(this.boton2),this.pageContainer.appendChild(this.pageContent),this.pageContent.style.display="none"}showPage(){this.pageContent.style.display="flex"}show(){this.pageContent.style.display="flex",console.log("show page age gate")}hide(){this.pageContent.style.display="none",console.log("hide page age gate")}}class AgeGateOut extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.pageContainer=document.getElementById("experienceContainer"),this.pageContent=document.createElement("div"),this.pageContent.className="fullscreen-div",this.boton1=document.createElement("button"),this.boton1.textContent="Volver a intentar",this.boton1.onclick=()=>{this.trigger("ageRetry")},this.pageContent.appendChild(this.boton1),this.pageContainer.appendChild(this.pageContent),this.pageContent.style.display="none"}show(){this.pageContent.style.display="flex"}hide(){this.pageContent.style.display="none"}}const _zee=new Vector3(0,0,1),_euler=new Euler,_q0=new Quaternion,_q1=new Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),_changeEvent={type:"change"};class DeviceOrientationControls extends EventDispatcher{constructor(e){super(),window.isSecureContext===!1&&console.error("THREE.DeviceOrientationControls: DeviceOrientationEvent is only available in secure contexts (https)");const t=this,n=1e-6,i=new Quaternion;this.object=e,this.object.rotation.reorder("YXZ"),this.enabled=!0,this.deviceOrientation={},this.screenOrientation=0,this.alphaOffset=0;const r=function(l){t.deviceOrientation=l},a=function(){t.screenOrientation=window.orientation||0},o=function(l,c,h,u,d){_euler.set(h,c,-u,"YXZ"),l.setFromEuler(_euler),l.multiply(_q1),l.multiply(_q0.setFromAxisAngle(_zee,-d))};this.connect=function(){console.log("DOC connect"),a(),window.DeviceOrientationEvent!==void 0&&typeof window.DeviceOrientationEvent.requestPermission=="function"?window.DeviceOrientationEvent.requestPermission().then(function(l){l=="granted"&&(console.log("DOC GRANTED"),window.addEventListener("orientationchange",a),window.addEventListener("deviceorientation",r))}).catch(function(l){console.error("THREE.DeviceOrientationControls: Unable to use DeviceOrientation API:",l)}):(console.log("DOC GRANTED"),window.addEventListener("orientationchange",a),window.addEventListener("deviceorientation",r)),t.enabled=!0},this.disconnect=function(){window.removeEventListener("orientationchange",a),window.removeEventListener("deviceorientation",r),t.enabled=!1},this.update=function(){if(t.enabled===!1)return;const l=t.deviceOrientation;if(l){const c=l.alpha?MathUtils.degToRad(l.alpha)+t.alphaOffset:0,h=l.beta?MathUtils.degToRad(l.beta):0,u=l.gamma?MathUtils.degToRad(l.gamma):0,d=t.screenOrientation?MathUtils.degToRad(t.screenOrientation):0;o(t.object.quaternion,c,h,u,d),8*(1-i.dot(t.object.quaternion))>n&&(i.copy(t.object.quaternion),t.dispatchEvent(_changeEvent))}},this.dispose=function(){t.disconnect()},this.connect()}}class CameraControl{constructor(){gt(this,"mouse",new Vector2);this.experience=new Experience,this.sizes=this.experience.sizes,this.active=!1;let e=this;this.docGranted=!1,this.experience.camera.instance.rotation.reorder("YXZ"),typeof DeviceMotionEvent<"u"&&typeof DeviceMotionEvent.requestPermission=="function"&&DeviceMotionEvent.requestPermission().then(t=>{t=="granted"&&(e.docGranted=!0,e.controls=new DeviceOrientationControls(e.experience.camera.instance),window.addEventListener("devicemotion",n=>{e.controls.update()}))}).catch(console.error),document.addEventListener("mousemove",t=>{e.mouse.x=t.clientX/window.innerWidth*2-1,e.mouse.y=-(t.clientY/window.innerHeight)*2+1,e.updateMouseMove()},!1)}updateMouseMove(){this.docGranted||Math.abs(this.mouse.x)>.3&&Math.abs(this.mouse.x)<.9}update(){if(!this.active)return;const e=[0,.15],t=[.15,.6],n=[.6,.9];let i=Math.abs(this.mouse.x),r=0;if(i<=e[1])r=0;else if(i<=t[1]){let a=(i-e[1])/(t[1]-e[1]);r=a*a}else if(i<=n[1]){let a=(i-t[1])/(n[1]-t[1]);r=(1-a)*(1-a)}else r=0;this.experience.camera.instance.rotation.y+=-this.mouse.x*r*.01,this.experience.camera.instance.rotation.x+=this.mouse.y*r*.01}}class HomeEnvironment{constructor(){this.experience=new Experience,this.scene=this.experience.scene,this.resources=this.experience.resources,this.debug=this.experience.debug,this.setSunLight()}setSunLight(){this.sunLight=new DirectionalLight("#ffffff",1),this.sunLight.castShadow=!0,this.sunLight.shadow.camera.far=200,this.sunLight.shadow.camera.near=15,this.sunLight.shadow.mapSize.set(2048,2048),this.sunLight.shadow.normalBias=.05,this.sunLight.position.set(-6,20,3)}setEnvironmentMap(){this.environmentMap={},this.environmentMap.intensity=.4,this.environmentMap.texture=this.resources.items.environmentMapTexture,this.environmentMap.texture.colorSpace=SRGBColorSpace,this.scene.environment=this.environmentMap.texture,this.environmentMap.updateMaterials=()=>{this.scene.traverse(e=>{e instanceof Mesh&&e.material instanceof MeshStandardMaterial&&(e.material.envMap=this.environmentMap.texture,e.material.envMapIntensity=this.environmentMap.intensity,e.material.needsUpdate=!0)})},this.environmentMap.updateMaterials()}}const homeSources=[{name:"environmentMapTexture",type:"cubeTexture",path:["textures/environmentMap/px.jpg","textures/environmentMap/nx.jpg","textures/environmentMap/py.jpg","textures/environmentMap/ny.jpg","textures/environmentMap/pz.jpg","textures/environmentMap/nz.jpg"]},{name:"coronacap",type:"texture",path:"textures/test/coronacap.png"},{name:"grassColorTexture",type:"texture",path:"textures/dirt/color.jpg"},{name:"grassNormalTexture",type:"texture",path:"textures/dirt/normal.jpg"},{name:"panoramaImage",type:"texture",path:"textures/panorama/panorama0701.jpg"},{name:"panoramaTestBottle",type:"texture",path:"textures/panorama/panorama_test_bottle.jpg"},{name:"panoramaTestNoise",type:"texture",path:"textures/panorama/panorama_test_noise.jpg"},{name:"coronaBottle",type:"gltfModel",animations:["LemonAction"],path:"models/coronaBottle.gltf"},{name:"test02",type:"gltfModel",path:"models/test02.gltf"},{name:"bobble",type:"gltfModel",animations:["Cylinder.002Action.001"],path:"models/bobble.gltf"},{name:"bobble02",type:"gltfModel",path:"models/bobble_nobake.gltf"}];var vertex_default=`varying vec2 v_uv;

void main() {
    v_uv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}`,fragment_default=`varying vec2 v_uv;
...
void main() {
    ...
    vec4 bottleMask = texture(u_maskBottle,v_uv);
    float mixValue = u_mix;
    float visibility = u_visibility;
    ...
    gl_FragColor = map*visibility;
    
    

}`;class HomePanorama{constructor(e,t,n){this.experience=new Experience,this.scene=this.experience.scene,this.time=this.experience.time,this.debug=this.experience.debug,this.geometry=new SphereGeometry(100,60,40),this.geometry.scale(-1,1,1),this.geometry.doubleSided=!1,this.texture=e,this.maskBottle=t,this.noise=n,this.texture.colorSpace=SRGBColorSpace,this.maskBottle.colorSpace=SRGBColorSpace,this.noise.colorSpace=SRGBColorSpace,this.material=new MeshBasicMaterial({map:this.texture,side:BackSide}),this.visibility=1;const i={u_time:{value:0},u_mix:{value:0},u_map:{value:this.texture},u_maskBottle:{value:this.maskBottle},u_noise:{value:this.noise},u_visibility:{value:this.visibility}};this.shaderMaterial=new ShaderMaterial({vertexShader:vertex_default,fragmentShader:fragment_default,uniforms:i,side:FrontSide}),this.mesh=new Mesh(this.geometry,this.shaderMaterial),this.mesh.name="panoramaMesh"}hide(){gsapWithCSS.set(this.mesh.material.uniforms.u_visibility,{value:0})}show(){gsapWithCSS.set(this.mesh.material.uniforms.u_visibility,{value:1})}update(){this.mesh.material.uniforms.u_time.value=this.experience.time.elapsed/1e3}}class Home{constructor(){this.experience=new Experience,this.scene=this.experience.scene,this.homeResources=new Resources(homeSources),this.homeObjects=new Group,this.experience.preloader.active||this.experience.preloader.show(),this.homeResources.on("ready",()=>{this.homeEnvironment=new HomeEnvironment,this.homeObjects.add(this.homeEnvironment.sunLight),this.homePanorama=new HomePanorama(this.homeResources.items.panoramaImage,this.homeResources.items.panoramaTestBottle,this.homeResources.items.panoramaTestNoise),this.homeObjects.add(this.homePanorama.mesh),this.homePanorama.show(),this.planeGroup=new Group,this.pgeometry=new PlaneGeometry(5,3),this.pmaterial=new MeshBasicMaterial({color:16777215,side:FrontSide,transparent:!0,opacity:.5}),this.planeGroup.position.copy(this.experience.camera.instance.position),this.homeObjects.add(this.planeGroup),this.spots=[{name:"spot_radio",degX:-93,degY:-12,width:14,height:8,position:{x:0,y:-2,z:0}}],this.spot_active="",this.spot_radio=new Hotspot("spot_radio",-93,-12,14,8),this.spot_radio.setPosition(0,-2,0),this.homeObjects.add(this.spot_radio.element),this.spot_radio.on("hotspot_click",()=>{this.spot_active==""&&(this.spot_active="radio",this.experience.merch.showPage(),this.experience.pause())}),this.spot_hand=new Hotspot("spot_hand",135,-4,34,14),this.spot_hand.setPosition(0,-2,0),this.homeObjects.add(this.spot_hand.element),this.spot_hand.on("hotspot_click",()=>{this.spot_active==""&&(this.experience.preloader.show("pshow_ar",1),this.experience.cameraControl.active=!1,this.experience.preloader.on("pshow_ar",()=>{console.log("pshow_ar"),this.hide(),setTimeout(()=>{this.experience.preloader.hide("phide_ar",.3),this.experience.videoAR.play()},500)}))}),this.spot_easteregg=new Hotspot("spot_easteregg",91,3,7,7),this.spot_easteregg.setPosition(0,-2,0),this.homeObjects.add(this.spot_easteregg.element),this.spot_easteregg.on("hotspot_click",()=>{this.spot_active==""&&(this.spot_active="easteregg",this.experience.easterEgg.showPage(),this.experience.pause())});let e=homeSources.find(n=>n.name==="bobble");this.bobble=new ModelElement("bobble",this.homeResources.items.bobble,e.animations),this.bobble.setPosition(-16,-10,-16),this.bobble.setScale(4.8,1),this.homeObjects.add(this.bobble.element),this.bobble.setRotation(20),this.bobble.playAnimation("Cylinder.002Action.001"),this.spot_bobble=new Hotspot("spot_bobble",-44,-5,9,25),this.spot_bobble.setPosition(0,-2,0),this.homeObjects.add(this.spot_bobble.element),this.spot_bobble.on("hotspot_click",()=>{this.spot_active==""&&(console.log("hand clicked"),this.spot_active="spot_bobble",this.experience.behind.showPage(),this.experience.pause())});let t=homeSources.find(n=>n.name==="coronaBottle");this.coronaBottle=new ModelElement("coronaBottle",this.homeResources.items.coronaBottle,t.animations),this.coronaBottle.setPosition(-60,-20,5),this.coronaBottle.setScale(0,1),this.homeObjects.add(this.coronaBottle.element),this.coronaBottle.setRotation(90),this.testElement=new ModelElement("test02",this.homeResources.items.test02),this.testElement.setPosition(-10,-20,50),this.homeObjects.add(this.testElement.element)})}update(){this.plane&&this.plane.update(),this.coronaBottle&&(this.coronaBottle.update(),this.coronaBottle.updateAnim()),this.bobble&&(this.bobble.update(),this.bobble.updateAnim()),this.testElement&&(this.testElement.update(),this.testElement.updateAnim()),this.homePanorama&&this.homePanorama.update(),this.pplane&&(this.planeGroup.rotation.y=-Math.PI/2+this.experience.camera.instance.rotation.y)}hide(){this.experience.camera.deactivateControls(),this.scene.remove(this.homeObjects)}hideScene(){this.experience.camera.deactivateControls(),this.experience.preloader.show(),this.experience.active=!1,this.experience.preloader.on("pHidden",()=>{this.scene.remove(this.homeObjects)})}showScene(){this.scene.add(this.homeObjects),this.experience.camera.activateControls()}}class Merch extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.pageContainer=document.getElementById("experienceContainer"),this.pageContent=document.createElement("div"),this.pageContent.className="merch-div",this.boton1=document.createElement("button"),this.boton1.textContent="boton de prueba";let e=this;this.boton1.onclick=()=>{e.trigger("merch")},this.pageContent.appendChild(this.boton1),this.pageContainer.appendChild(this.pageContent)}showPage(){this.pageContent.style.display="flex",this.pageContent.style.transform="scale(1)",this.pageContent.style.zIndex=200}hidePage(){this.pageContent.style.transform="scale(0)",this.pageContent.style.display="none",this.pageContent.style.zIndex=0}show(){this.pageContent.style.display="flex"}hide(){this.pageContent.style.display="none"}}class EasterEgg extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.pageContainer=document.getElementById("experienceContainer"),this.pageContent=document.createElement("div"),this.pageContent.className="overlay-div",this.boton1=document.createElement("button"),this.boton1.textContent="Open External",this.boton1.onclick=()=>{this.trigger("action")},this.pageContent.appendChild(this.boton1),this.closeButton=document.createElement("button"),this.closeButton.textContent="X",this.closeButton.onclick=()=>{this.trigger("close")},this.pageContent.appendChild(this.closeButton),this.pageContainer.appendChild(this.pageContent)}showPage(){this.pageContent.style.display="flex",this.pageContent.style.transform="scale(1)",this.pageContent.style.zIndex=200}hidePage(){this.pageContent.style.transform="scale(0)",this.pageContent.style.display="none",this.pageContent.style.zIndex=0}show(){this.pageContent.style.display="flex"}hide(){this.pageContent.style.display="none"}}class VideoAR extends EventEmitter{constructor(){super(),this.experience=new Experience,this.loaded=!1,this.playing=!1,this.active=!1,this.video=document.getElementById("videoAR"),this.video.height=window.innerHeight,this.video.width=window.innerWidth;let e=this;this.video.addEventListener("loadeddata",function(){e.loaded=!0},!1)}play(){this.playLoadedVideo()}playLoadedVideo(){console.log("play videoAR"),this.playing=!0,this.resize(),this.video.play(),this.video.style.display="flex",(this.video.duration-.3)*1e3,this.video.onended=e=>{this.experience.preloader.show("pshow_stage",.5),setTimeout(()=>{this.hide()},500)}}hide(){this.trigger("videoAR_hide"),this.playing=!1,this.video.style.display="none"}update(){this.playing}resize(){let e=this.video.videoWidth/this.video.videoHeight,t=window.innerWidth/window.innerHeight;this.video.style.position="relative",t<e?(this.video.setAttribute("width",window.innerHeight*e),this.video.setAttribute("height",window.innerHeight),this.video.style.left=`${-window.innerHeight/2}px`):(console.log("horizontal"),this.video.setAttribute("width",window.innerWidth),this.video.setAttribute("height",window.innerWidth/e),this.video.style.left="0px"),this.playing}}class Behind extends EventEmitter{constructor(){super(),this.experience=new Experience,this.sizes=this.experience.sizes,this.pageContainer=document.getElementById("experienceContainer"),this.pageContent=document.createElement("div"),this.pageContent.className="behind-div",this.boton1=document.createElement("button"),this.boton1.textContent="boton de prueba";let e=this;this.boton1.onclick=()=>{e.trigger("behind")},this.pageContent.appendChild(this.boton1),this.pageContainer.appendChild(this.pageContent)}showPage(){this.pageContent.style.display="flex",this.pageContent.style.transform="scale(1)",this.pageContent.style.zIndex=200}hidePage(){this.pageContent.style.transform="scale(0)",this.pageContent.style.display="none",this.pageContent.style.zIndex=0}show(){this.pageContent.style.display="flex"}hide(){this.pageContent.style.display="none"}}let instance=null;class Experience{constructor(e){if(instance)return instance;instance=this,window.experience=this,this.canvas=e,this.active=!1,this.debug=new Debug,this.sizes=new Sizes,this.time=new Time,this.scene=new Scene,this.camera=new Camera,this.renderer=new Renderer,this.preloader=new Preloader,this.resources=new Resources(sources),this.stage=new Stage,this.home=new Home,this.userCam=new UserCam("experienceContainer"),this.videoScreen=new VideoScreen,this.videoAR=new VideoAR,this.videoAR.on("videoAR_hide",()=>{console.log("video ar hide"),this.preloader.hide("phide_arScene",1),this.stage.showScene(),this.userCam.show(),this.cameraControl.active=!0}),this.ageGate=new AgeGate,this.ageGateOut=new AgeGateOut,this.merch=new Merch,this.merch.on("merch",()=>{this.merch.hidePage(),this.active=!0,setTimeout(()=>{this.home.spot_active=""},500)}),this.behind=new Behind,this.behind.on("behind",()=>{this.behind.hidePage(),this.active=!0,setTimeout(()=>{this.home.spot_active=""},500)}),this.easterEgg=new EasterEgg,this.easterEgg.on("action",()=>{this.easterEgg.hidePage(),window.open("https://www.theelectricfactory.com","_blank"),this.active=!0,setTimeout(()=>{this.home.spot_active=""},500)}),this.easterEgg.on("close",()=>{this.easterEgg.hidePage(),this.active=!0,setTimeout(()=>{this.home.spot_active=""},500)}),this.sizes.on("resize",()=>{this.resize()}),this.time.on("runFrame",()=>{this.update()});const t=window.location.search;let i=new URLSearchParams(t).get("location");this.active=!0,this.canvas.style.display="block",this.ageGate.showPage(),this.preloader.hide("load_hide",.5),this.preloader.on("load_hide",()=>{this.canvas.style.display="none"}),this.ageGate.on("ageNotOk",()=>{this.ageGateOut.show(),this.ageGate.hide()}),this.ageGateOut.on("ageRetry",()=>{this.ageGate.show(),this.ageGateOut.hide()}),this.ageGate.on("ageOk",()=>{this.cameraControl=new CameraControl,this.canvas.style.display="block",console.log("age gate ok"),console.log("show preloader"),this.preloader.show("ageGate",1)}),this.preloader.on("shwoAgeGate",()=>{console.log("preloader show"),this.ageGate.hide(),this.userCam.init(),i==="home"?(this.videoScreen.play(),this.preloader.hide("ageGate",1)):(this.stage.showScene(),this.cameraControl.active=!0,this.userCam.show())}),this.videoScreen.on("videoCompleted",()=>{this.preloader.show("video01_end",1)}),this.preloader.on("video01_end",()=>{this.videoScreen.hide(),this.home.showScene(),this.cameraControl.active=!0,this.userCam.show(),this.preloader.hide("stage_show",1)})}pause(){this.active=!1}resume(){this.active=!0}resize(){console.log("resize"),this.camera.resize(),this.renderer.resize(),this.videoScreen.resize(),this.userCam&&this.userCam.resize(),this.videoAR&&this.videoAR.resize()}update(){var e;this.active&&(this.preloader.active,this.camera.update(),this.stage.update(),this.home.update(),this.preloader.update(),this.renderer.update(),(e=this.cameraControl)==null||e.update())}}new Experience(document.querySelector("canvas.experienceContainer"));
//# sourceMappingURL=index-b74a7fa3.js.map
